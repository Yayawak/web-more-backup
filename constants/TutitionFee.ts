...
import iconChem from '@/assets/icons/icon_chemist.svg'
import iconMath from '@/assets/icons/icon_math.svg'
import iconPhysic from '@/assets/icons/icon_physics.svg'
import iconBio from '@/assets/icons/icon_biology.svg'
import iconCom from '@/assets/icons/icon_comsci.svg'
import iconStat from '@/assets/icons/icon_stat.svg'
import iconKdai from '@/assets/icons/icon_kdai.svg'

export const courseSet: { [key: string]: string } = {
  bachelor: 'ปริญญาตรี',
  master: 'ปริญญาโท',
  doctorate: 'ปริญญาเอก',
}
